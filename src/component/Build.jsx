...
<<<<<<< HEAD
        <p>I&apos;m <span className='text-[#e80b24]'>Yahoulbo Felix</span>, a 20-year-old student belonging to the Ahmadu Bello University.
         I&apos;m a enthusiast Programer,and software developer specialize in Frontend Development,writing computer program is one of my best passion,and solving real world problem and  
=======
...
<<<<<<< HEAD
        <p className='bg-[#0e4465a0] mx-1 lg:mx-2 py-1 px-1 cursor-pointer rounded-lg font-medium'><a href='https://www.linkedin.com/in/kalibe-felix-38aa2a294'><FontAwesomeIcon icon={faLinkedinIn} className='px-2'/>LinkedIn</a></p>
=======
...
<h4 className='text-lg font-sans text-gray-300 my-3 px-1'>Janvier 2024</h4>
<p className='text-xl my-2 text-white px-1'>AnasDev is created to teach technologie course and some others features and get certified after learn some course .</p>
      ...
      src='/yahoulbo-portfolio/webdocs.png' className='h-[35vh] w-full'/>
       <h4 className='text-lg font-sans text-gray-300 px-1 my-3'>septembre 2023</h4>
=======
      <div className='border  lg:me-2' id='element'>
<img src='/yahoulbo-portfolio/anasdev.png' className='h-[35vh] w-full'/>
