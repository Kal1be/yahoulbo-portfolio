...
function parallax({type}) {
  ...
  const yText=useTransform(scrollYProgress,[0,1],["0%","-230%"])
  return (
    <div className="parallax" style={{background:type==="services" ? "linear-gradient(180deg,#111132,#0c0c1d)":"linear-gradient(180deg,#111132,#505064)"}}>
      ...
      <motion.div 
      className="planets"
      style={{y:yBg,backgroundImage:`url(${type==="services"?"/yahoulbo-portfolio/planets.png":"/yahoulbo-portfolio/sun.png"})`}}
 >
      </motion.div> 
